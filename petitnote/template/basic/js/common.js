        ...
        if (response.ok) {
          ...
          response.text().then((text) => {
            if (text.startsWith("error\n")) {
              ...
              return (elem_error_message.innerText = error_message);
            }
...
class petitNoteImagePreview {
  constructor() {
    ...
    this.paint_form_fileInput = paint_form?.querySelector('input[type="file"]');
  ...
  updateFormStyle() {
    ...
    if (
      ...
      if (
        ...
        //ボタンにボーダー
        this.elem_form_submit.style.border = "2px solid rgb(255 170 192)"; // ボーダーを設定
        ...
        if (reader && preview instanceof HTMLImageElement) {
          ...
          if (typeof result === "string") {
            ...
            testImg.onload = () => {
              ...
              setTimeout(() => {
                if (this.post_com instanceof HTMLTextAreaElement) {
                  const previewoffsetHeight = preview.offsetHeight;
