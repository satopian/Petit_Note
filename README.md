...
##  22/05/04 v0.19.3
- v0.19.2発生した指定サイズ以上の実体データ縮小処理が効かなくなるバグを修正しました。
##  22/05/04 v0.19.2
### 画像差し換え機能を追加
...
従来の方式でもログファイルの存在確認を最初に行っていましたので、アクセスが集中するようなケースでなければ発生しにくい問題だとは思いますが、一瞬の隙をついたタイミングで発生する可能性がゼロではないのでぜひアップデートをお願いします。
...
[Petit Note v0.19.2 リリース](https://github.com/satopian/Petit_Note/releases/latest)
